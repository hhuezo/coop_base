...
@section('contenido')
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Reporte por rubros <small></small></h2>
                ...
                <div class="x_content">
                    <br />
                    <form action="{{ url('reportes/rubros_generar') }}" data-parsley-validate
                        class="form-horizontal form-label-left" target="_blank" method="GET">
